package com.example.lenovo.jiyiji.Date;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener  {
     ...
     * 被选择的日期
     */
    public List<Datebean> datebeans=new ArrayList<>();
    ...
    public void onSelect(View view, String selected) {
        ...
        switch (view.getId()) {
            ...
            case R.id.dpv_month:
                ...
                Months=timeUnit - lastSelectedMonth;
                break;
